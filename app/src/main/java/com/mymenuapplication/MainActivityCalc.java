...
public class MainActivityCalc extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            startActivity(new Intent(MainActivityCalc.this, MainActivity.class));

        }
        else if (id == R.id.nav_calc) {
            Toast.makeText(this, "Vous êtes déjà dans la page de calculatrice", Toast.LENGTH_LONG).show();
            return true;
        }
